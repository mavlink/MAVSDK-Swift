...
struct Mavsdk_Rpc_Geofence_Polygon {
  ...
  /// Fence type
  var type: Mavsdk_Rpc_Geofence_Polygon.TypeEnum = .inclusion
...
extension Mavsdk_Rpc_Geofence_Polygon.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Mavsdk_Rpc_Geofence_Polygon.TypeEnum] = [
    .inclusion,
    .exclusion,
  ]
}
...
extension Mavsdk_Rpc_Geofence_Polygon.TypeEnum: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "INCLUSION"),
...
extension Mavsdk_Rpc_Geofence_GeofenceResult.Result: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .same(proto: "ERROR"),
    3: .same(proto: "TOO_MANY_GEOFENCE_ITEMS"),
    4: .same(proto: "BUSY"),
