...
struct Mavsdk_Rpc_Failure_InjectResponse {
  ...
  var failureResult: Mavsdk_Rpc_Failure_FailureResult {
    get {return _storage._failureResult ?? Mavsdk_Rpc_Failure_FailureResult()}
    set {_uniqueStorage()._failureResult = newValue}
  }
  /// Returns true if `failureResult` has been explicitly set.
  var hasFailureResult: Bool {return _storage._failureResult != nil}
  /// Clears the value of `failureResult`. Subsequent reads from it will return its default value.
  mutating func clearFailureResult() {_uniqueStorage()._failureResult = nil}
...
extension Mavsdk_Rpc_Failure_InjectResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _failureResult: Mavsdk_Rpc_Failure_FailureResult? = nil
    ...
    init(copying source: _StorageClass) {
      _failureResult = source._failureResult
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularMessageField(value: &_storage._failureResult)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      if let v = _storage._failureResult {
  ...
  static func ==(lhs: Mavsdk_Rpc_Failure_InjectResponse, rhs: Mavsdk_Rpc_Failure_InjectResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._failureResult != rhs_storage._failureResult {return false}
        return true
      }
