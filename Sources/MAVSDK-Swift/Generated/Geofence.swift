...
public class Geofence {
    ...
    public struct Polygon: Equatable {
        ...
        public enum TypeEnum: Equatable {
            case inclusion
            case exclusion
            case UNRECOGNIZED(Int)

            internal var rpcType: Mavsdk_Rpc_Geofence_Polygon.TypeEnum {
                switch self {
                case .inclusion:
                    return .inclusion
                case .exclusion:
            ...
            internal static func translateFromRpc(_ rpcType: Mavsdk_Rpc_Geofence_Polygon.TypeEnum) -> TypeEnum {
                switch rpcType {
                case .inclusion:
                    return .inclusion
                case .exclusion:
        ...
        public init(points: [Point], type: TypeEnum) {
            self.points = points
            self.type = type
        }
        ...
        internal static func translateFromRpc(_ rpcPolygon: Mavsdk_Rpc_Geofence_Polygon) -> Polygon {
            return Polygon(points: rpcPolygon.points.map{ Point.translateFromRpc($0) }, type: TypeEnum.translateFromRpc(rpcPolygon.type))
        }
