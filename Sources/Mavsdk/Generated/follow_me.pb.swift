...
struct Mavsdk_Rpc_FollowMe_GetConfigResponse {
  ...
  var config: Mavsdk_Rpc_FollowMe_Config {
    get {return _config ?? Mavsdk_Rpc_FollowMe_Config()}
  ...
  fileprivate var _config: Mavsdk_Rpc_FollowMe_Config? = nil
}
...
struct Mavsdk_Rpc_FollowMe_SetConfigResponse {
  ...
  var followMeResult: Mavsdk_Rpc_FollowMe_FollowMeResult {
    get {return _followMeResult ?? Mavsdk_Rpc_FollowMe_FollowMeResult()}
    set {_followMeResult = newValue}
  }
  /// Returns true if `followMeResult` has been explicitly set.
  var hasFollowMeResult: Bool {return self._followMeResult != nil}
  /// Clears the value of `followMeResult`. Subsequent reads from it will return its default value.
  mutating func clearFollowMeResult() {self._followMeResult = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _followMeResult: Mavsdk_Rpc_FollowMe_FollowMeResult? = nil
}
...
struct Mavsdk_Rpc_FollowMe_SetTargetLocationRequest {
  ...
  var location: Mavsdk_Rpc_FollowMe_TargetLocation {
    get {return _location ?? Mavsdk_Rpc_FollowMe_TargetLocation()}
  ...
  fileprivate var _location: Mavsdk_Rpc_FollowMe_TargetLocation? = nil
}
...
extension Mavsdk_Rpc_FollowMe_Config: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularFloatField(value: &self.minHeightM) }()
      case 2: try { try decoder.decodeSingularFloatField(value: &self.followDistanceM) }()
      case 3: try { try decoder.decodeSingularEnumField(value: &self.followDirection) }()
      case 4: try { try decoder.decodeSingularFloatField(value: &self.responsiveness) }()
      default: break
      }
    }
  }
...
extension Mavsdk_Rpc_FollowMe_TargetLocation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularFloatField(value: &self.velocityXMS) }()
      case 5: try { try decoder.decodeSingularFloatField(value: &self.velocityYMS) }()
      case 6: try { try decoder.decodeSingularFloatField(value: &self.velocityZMS) }()
      default: break
      }
    }
  }
...
extension Mavsdk_Rpc_FollowMe_SetConfigResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._followMeResult) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._followMeResult {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Mavsdk_Rpc_FollowMe_SetConfigResponse, rhs: Mavsdk_Rpc_FollowMe_SetConfigResponse) -> Bool {
    if lhs._followMeResult != rhs._followMeResult {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
