...
extension DronecodeSdk_Rpc_Mission_MissionServiceProvider {
  ...
  internal func handleMethod(_ method: String, handler: Handler) throws -> ServerStatus? {
    ...
    case "/dronecode_sdk.rpc.mission.MissionService/GetCurrentMissionItemIndex":
      return try DronecodeSdk_Rpc_Mission_MissionServiceGetCurrentMissionItemIndexSessionBase(
        handler: handler,
        providerBlock: { try self.getCurrentMissionItemIndex(request: $0, session: $1 as! DronecodeSdk_Rpc_Mission_MissionServiceGetCurrentMissionItemIndexSessionBase) })
          .run()
    case "/dronecode_sdk.rpc.mission.MissionService/GetMissionCount":
      return try DronecodeSdk_Rpc_Mission_MissionServiceGetMissionCountSessionBase(
        handler: handler,
        providerBlock: { try self.getMissionCount(request: $0, session: $1 as! DronecodeSdk_Rpc_Mission_MissionServiceGetMissionCountSessionBase) })
          .run()
